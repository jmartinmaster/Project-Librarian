...
## Output
- Build folder: `dist/TheLibrarian/`
- Local install dir: `~/.local/opt/the-librarian/`
- Desktop entry: `~/.local/share/applications/the-librarian.desktop`
...
- Desktop entry includes `StartupWMClass=TheLibrarian` to improve dock/taskbar icon matching.
